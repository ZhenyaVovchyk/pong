...
function draw() {
    ...
    if (!start) {
        ...
        context.textBaseline = 'center';
        context.fillStyle = '#000';
        context.fillText("Жги Леха! ;)", game.width / 2, game.height / 2 - 50);
        context.font = 'bold 16px courier';
        context.textBaseline = 'top';
        context.fillStyle = '#000';
        context.fillText("click on me", game.width / 2, game.height / 2 + 25);
        context.textBaseline = 'bottom';
        context.fillText("create by Zhenia Vovchyk", game.width / 2, game.height);
    }
}
...
function init() {
    ...
    game = new rect("red", 0, 0, 1200, 600);

    game.total = 0;
    game.win = 0;
    game.lose = 0;
    // Ракетки-игроки
    ai = new rect("black", 10, game.height / 2 - 40, 20, 50);
    player = new rect("#black", game.width - 30, game.height / 2 - 40, 20, 50);
    // количество очков
    ai.scores = 0;
    player.scores = 0;
    // наш квадратный игровой "шарик"
    ball = new rect("#fff", 40, game.height / 2 - 20, 20, 20);
